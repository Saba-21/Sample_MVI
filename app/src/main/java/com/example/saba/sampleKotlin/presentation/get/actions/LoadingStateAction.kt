...
import com.example.saba.sampleKotlin.presentation.get.RESULT_VIEW_LOADING_STATE
import com.example.saba.sampleKotlin.presentation.get.ResultViewState

class LoadingStateAction: ViewStateAction<ResultViewState>() {

    override fun newState(oldState: ResultViewState):
            ResultViewState = oldState.copy(state = RESULT_VIEW_LOADING_STATE)
