...
import com.example.saba.sampleMVI.domain.dataProvider.local.LocalDataProviderImpl
import com.example.saba.sampleMVI.domain.database.RepoDatabase
import com.example.saba.sampleMVI.domain.repository.Repository
import com.example.saba.sampleMVI.domain.repository.RepositoryImpl
...
class AppModule{
    ...
    @Named("base_url")
    fun provideBaseUrl():
            String = com.example.saba.sampleMVI.app.BASE_URL
    ...
    fun provideDatabase(context: Context):
            RepoDatabase = Room
                        .databaseBuilder(context, RepoDatabase::class.java, com.example.saba.sampleMVI.app.DB_NAME)
